...
namespace NDSSSF.Droid
{
    ...
    public class STE5_custom : ActivityBase
    {
      ...
      //  List<string> wordStrings;
        ...
        protected MyAdapter4 MyServiceItemsAdapter;
        ...
        protected async override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Resource.Layout.STE5_custom);
            ...
            nlistview = FindViewById<ListView>(Resource.Id.listViewC);
           
            
            wordList = (await DataRepository.Words.GetAll());
            // wordStrings = new List<string>();

            MyServiceItemsAdapter = new MyAdapter4(this, wordList);
            nlistview.Adapter = MyServiceItemsAdapter;
            nlistview.FastScrollEnabled = true;
            Button btn = FindViewById<Button>(Resource.Id.cbutton1);
