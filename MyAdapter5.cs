...
namespace NDSSSF.Droid
{
    ...
    public class MyAdapter5: NDSSSFBaseAdapter<Sentence> 
    {
      ...
      // STE1 s=new STE1();
       ...
       // Word worditem;
        ...
        //   Word w = new Word();
        public MyAdapter5(Activity context, List<Sentence> items) : base()
        {
            this.nItems = items;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            {
                view = LayoutInflater.From(nContext).Inflate(Resource.Layout.CustomRow4, null, false);
